...
- Al listar, podes filtrar por fecha y/o por nombre de la reserva; si no hay fecha, lista todas las de ese nombre.
- Si el cliente no da un nombre, usa el conversationId que recibas como identificador de la reserva.
